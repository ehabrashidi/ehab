...
<h2><?php if (count($results) > 0) {
			 ...
			 ?></h2>
<html>
		<form action="insert_shakwa_100.php"class="modal-content animate">
<label for="cust_c"><b>الاشتراك</b></label>
		...
		<label for="date_of_day"><b>التاريخ</b></label>
				...
				<label for="date_of_day"><b>الشكوي</b></label>
				<div class=""><input type="text" name="shakwa_r" value="" style=" height: 200px;"  autocomplete="off"></div><br>

<div class="">
					<button class="" type="submit">ارسال الشكوي</button> 
				</div>
</form>
